...
// 최단 기록 : 23년 2월 15일 8분 55초  /  총 도전 횟수 : 1
public class LoopEx05_풀이 {
	...
	public static void main(String[] args) {
		...
		while (i <= 5) {
			...
			if (choice == 2) shrimpBurgerCnt++;
			if (choice == 3) colaOrderCnt++;
				
			i++;
		}
		
		int totalPrice = bulgogiBurgerPrice * bulgogiBurgerCnt + shrimpBurgerPrice * shrimpBurgerCnt + colaPrice * colaOrderCnt;   
		...
		if (charge >= 0) {
			...
			System.out.println("=== 롯데이라 영수증 ===");
			System.out.println("1. 불고기 버거 : " + bulgogiBurgerCnt + "개");
			System.out.println("1. 새우 버거 : " + shrimpBurgerCnt + "개");
			System.out.println("1. 콜라 : " + colaOrderCnt + "개");
			System.out.println("1. 총금액 : " + totalPrice + "개");
			System.out.println("1. 잔돈 : " + charge + "개");
		}
		else {
